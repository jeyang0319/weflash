;(function () {
    ...
    function abab() {
        ...
        $main_page.classList.toggle('none')
        $test_result.classList.toggle('show')
      }
    ...
    const init = () => {
        for (let index = 1; index <= 16; index++) {
            ...
            carouselImage.addEventListener('click', () => {
              ...
              const $main_page = get('.main_page')
              const $test_result = get('.test_result')
              ...
              for (let i = 0; i < mbtiArr.length; i++) {
                  ...
                  if (mbti_result[mbti_type]["num"] === index) {
                    ...
                    abab()
                    // result_mbti.innerHTML = mbti_result[mbti_type]["mbti"]
                    // result_game.innerHTML = mbti_result[mbti_type]["game"]
                    // result_txt.innerHTML = mbti_result[mbi_type]["text"]
                    // let img = mbti_result[mbti_type]["img"]
